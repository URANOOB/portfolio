...
export const skillGroups: SkillGroup[] = [
  {
    ...
    skills: [
      { name: "React", level: "Principal", projects: ["Inglés Pa’ la Paz", "R/COON Porfolio"] },
      { name: "Next.js", level: "Principal", projects: ["Inglés Pa’ la Paz", "R/COON Porfolio"] },
      { name: "TypeScript", level: "Principal", projects: ["Inglés Pa’ la Paz", "R/COON Porfolio"] },
      { name: "JavaScript", level: "Trabajo habitual", projects: ["Aplicaciones web"] },
      { name: "Tailwind CSS", level: "Trabajo habitual", projects: ["R/COON Porfolio"] },
