...
export const skillGroups: SkillGroup[] = [
  {
    ...
    skills: [
      { name: "React", level: "Principal", projects: ["Inglés Pa’ la Paz", "R/COON OS"] },
      { name: "Next.js", level: "Principal", projects: ["Inglés Pa’ la Paz", "R/COON OS"] },
      { name: "TypeScript", level: "Principal", projects: ["Inglés Pa’ la Paz", "R/COON OS"] },
      { name: "JavaScript", level: "Trabajo habitual", projects: ["Aplicaciones web"] },
      { name: "Tailwind CSS", level: "Trabajo habitual", projects: ["R/COON OS"] },
