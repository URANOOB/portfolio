...
export const skillGroups: SkillGroup[] = [
  {
    ...
    skills: [
      { name: "React", level: "Core", projects: ["Inglés Pa’ la Paz", "R/COON OS"] },
      { name: "Next.js", level: "Core", projects: ["Inglés Pa’ la Paz", "R/COON OS"] },
      { name: "TypeScript", level: "Core", projects: ["Inglés Pa’ la Paz", "R/COON OS"] },
      { name: "JavaScript", level: "Regular", projects: ["Web Applications"] },
      { name: "Tailwind CSS", level: "Regular", projects: ["R/COON OS"] },
